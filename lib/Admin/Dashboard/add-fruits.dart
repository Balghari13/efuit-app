...
class AddFruitsAdmin extends StatefulWidget {
  const AddFruitsAdmin({Key? key}) : super(key: key);

  @override
  State<AddFruitsAdmin> createState() => _AddFruitsAdminState();
}

class _AddFruitsAdminState extends State<AddFruitsAdmin> {
